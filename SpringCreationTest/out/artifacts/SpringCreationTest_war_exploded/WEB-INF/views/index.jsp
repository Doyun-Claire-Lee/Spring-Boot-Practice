    ...
    <div class="content-container">
        <section class="guide">
            ...
            <div class="margin-top">
                <a href="customer/faq/1.do"><img src="images/customer/installInfo.png" /></a>
            </div>
            <!-- <div>
        2
        </div>
            ...
            <ul class="list margin-top">
                ...
                <li>
                        <span class="notice-title">
                            <a href="notice/detail.do">스프링 8강까지의 예제 코드</a>
                        </span>
                ...
                <li>
                        <span class="notice-title">
                            <a href="notice/detail.do">스프링 DI 예제 코드</a>
                        </span>
                ...
                <li>
                        <span class="notice-title">
                            <a href="notice/detail.do">뉴렉쌤 9월 초 국기과정 모집 안내</a>
                        </span>
                ...
                <li>
                        <span class="notice-title">
                            <a href="notice/detail.do">뉴렉처 강의 수강 방식 안내</a>
                        </span>
                ...
                <li>
                        <span class="notice-title">
                            <a href="notice/detail.do">자바 구조적인 프로그래밍 강의 예제 파일</a>
                        </span>
